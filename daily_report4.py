          ...
          if base == '販売分析ログ':
              ...
              for i, file in enumerate(filelists):
                  if i > MAX_CNT-1:
                      print(file[0])
                      #file_1 = os.rename(i[0], 'kasi.csv')
                      os.rename("C:/Users/古内翔平/Downloads/" + str(file[0]), "C:/Users/古内翔平/Downloads/" + str(i_1[2]) + '販売ログ.csv')
                      shutil.move("C:/Users/古内翔平/Downloads/" + str(i_1[2]) + '販売ログ.csv','C:/Users/古内翔平/OneDrive - 株式会社　ＴＲＩＮＩＴＹ　/業務会議/4⃣販売部/古内/myfile/dataf') 
